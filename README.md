...
| :------------------------------------------------------- | :-------------------------------- | :-------------------------------------------- |
| **[Agent 00](workshop/agents/00_format_agent)**          | Structured vs Unstructured Output | How to force JSON output for downstream apps. |
| **[Agent 01](workshop/agents/01_baseline_agent)**        | Baseline (Hallucination Risk)     | Without data, AI guesses.                     |
...
| **[Agent 05](workshop/agents/05_confirmed_write_agent)** | Human-in-the-Loop (Basic)         | Simple confirmations prevent accidents.       |
